...
public class mainTest {
        ...
        private static void ingresarResultados2025() {
            ...
            List<ResultadoService.ResultadoDTO> resultados = new ArrayList<>();
            ...
            for (Piloto piloto : pilotos) {
                ...
                try {
                    ...
                    ResultadoService.ResultadoDTO dto = new ResultadoService.ResultadoDTO(piloto.getId(), posicion);
